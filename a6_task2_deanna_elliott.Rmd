...
There is a significant association (i.e. non-independence) between an individual's politics and whether they consider themselves to be an environmentalist ($\chi$^2^(`r x2_tidy$parameter`) = `r round(x2_tidy$statistic, 2)`, *p* = 2.23e-18.
